...
public class JettyStart {
	...
	public static void main(String[] args) throws Exception {
		...
		JarUtils.replaceFile(warF, new File("conf/log4j.xml"));
		JarUtils.replaceFile(warF, new File("conf/context.properties"));
		JarUtils.replaceFile(warF, new File("conf/mongo.properties"));
