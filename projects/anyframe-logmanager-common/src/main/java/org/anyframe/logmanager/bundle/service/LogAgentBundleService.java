...
/**
 * This is LogAgentBundleService class.
 * 
...
public interface LogAgentBundleService {
	 ...
	 * @throws Exception
	 */
	public InputStream getLoggingPolicyFileInfo(String LoggingPolicyFilePath)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	public void saveLoggingPolicyFileInfo(String LoggingPolicyFilePath,
			String LoggingPolicyFileText) throws Exception;
