...
/**
 * This is LogSearchCondition class.
 * 
...
public class LogSearchCondition extends AnalysisLog {
	...
	/**
	 * @param durationTemplate
	 *            the durationTemplate to set
	 */
	...
	/**
	 * @param logTailingMode
	 *            the logTailingMode to set
	 */
	...
	/**
	 * @param logLevelDirection
	 *            the logLevelDirection to set
	 */
	...
	/**
	 * @param matchedLogOnly
	 *            the matchedLogOnly to set
	 */
	...
	public String toString() {
		return super.toString() + "\nLogSearchCondition [pageIndex=" + pageIndex + ", pageSize=" + pageSize + ", fromDateTime=" + fromDateTime + ", toDateTime=" + toDateTime + ", logLevelDirection="
				+ logLevelDirection + ", advancedOptions=" + advancedOptions + ", matchedLogOnly=" + matchedLogOnly + ",messageText=" + messageText + ", fromDate=" + fromDate + ", fromHour="
				+ fromHour + ", fromMinute=" + fromMinute + ", toDate=" + toDate + ", toHour=" + toHour + ", toMinute=" + toMinute + ", previousTimestamp=" + previousTimestamp + ", logTailingMode="
				+ logTailingMode + "]";
	}
