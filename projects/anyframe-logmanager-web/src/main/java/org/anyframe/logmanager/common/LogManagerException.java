 ...
 * @author Sooyeon Park
 */
public class LogManagerException extends BaseException {
	 ...
	 *            the exception that is wrapped in this exception
	 */
	public LogManagerException(final String message, final Throwable exception) {
	 ...
	 *            the message of this exception
	 */
	public LogManagerException(final String message) {
		super(message);
	}
}
