...
public class LogManagerController {
	...
	public String saveLogApplication(@RequestParam(value = "id") String id, 
			@RequestParam(value = "loggers[]", required = false) String[] loggers,
		...
		appService.saveLogApplication(param, loggers, appenders);
	...
	public String checkApplicationExist(@RequestParam(value = "appName") String appName, Model model, HttpServletRequest request) throws Exception {
		LogApplication param = new LogApplication();
		param.setAppName(appName);
	...
	public String getAppenderList(LogApplication param, Model model, HttpServletRequest request, HttpSession session) throws Exception {
		Account loginAccount = (Account)session.getAttribute("loginAccount");
		List<Appender> appenders = appService.getAppenderList(param, loginAccount.getUserType());
	...
	public String loadLog4jXml(LogApplication param, Model model, HttpServletRequest request) throws Exception {
	...
	public String viewAppDetail(LogApplication param, Model model, HttpServletRequest request) throws Exception {
		LogApplication app = null;
		app = appService.getLogApplication(param);
		model.addAttribute("app", app);
		return "jsonView";
	}
	...
	public String analysis4gridForm(LogSearchCondition searchCondition, Model model, HttpServletRequest request) throws Exception {
